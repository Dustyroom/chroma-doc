...
<details><summary>Example Shader</summary>
[](/assets/images/docs/interface/grass-plane-shader-interface.png){: .image-rounded}
</details>

<a href="#/attributes/" class="btn btn--primary">All shader attributes</a>
...
<details><summary>Simple one-gradient shader</summary>
...
<details><summary>Vertex displacement with a curve</summary>
...
<details><summary>Beautiful gradients</summary>
{% include video.html url='/assets/manual-videos/chroma-gradeint-randomizing.mp4' %}{: .image-rounded}
</details>
