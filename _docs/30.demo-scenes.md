...
#### Grass Plane Scene
In this scene you can find a simple plane with a single material holding a [Grass Plane](/example-shaders/#grass-plane) example shader responsible for a grass effect with all the essential parameters. This scene was designed as a showcase for the [Curves](/curve/).
