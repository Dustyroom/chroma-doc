...
<img src="/assets/images/docs/code-shader-example.png" height="auto" width="600" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh" />
