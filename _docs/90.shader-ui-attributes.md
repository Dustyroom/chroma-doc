...
| Result | <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/showif-result.png" height="auto" width="750"  style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh" />|
