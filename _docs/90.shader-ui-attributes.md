...
| Notes | ● The color is optional. If not specified, the default color is used (which is gray).<br/>● The color is in HTML format, it accepts HEX values, eg. `8A2BE2` or color names, eg. `red` ([full list](https://www.w3schools.com/tags/ref_colornames.asp)). |
| Usage: | |
