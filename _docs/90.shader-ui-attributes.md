...
| Usage: | |
| ● Shader Graph | <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/header-sg.webp" height="auto" width="400" border="20px solid" style="border-radius:1vh" /> |
| ● Code | `_AnyNameHere("[Header] My Header", Float) = 0.5` |
| Result | <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/header-result.png" height="auto" width="400"  border="2px" style="border-radius:0.5vh" /> |
