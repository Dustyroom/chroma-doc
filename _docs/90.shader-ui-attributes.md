...
| Usage: | |
| ● Shader Graph | <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/header-sg.webp" height="auto" width="400" style="border-style:solid border:darkgray border-radius:1vh" /> |
| ● Code | `_AnyNameHere("[Header] My Header", Float) = 0.5` |
| Result | <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/header-result.png" height="auto" width="400"  style="border-radius:0.5vh style:solid" /> |
...
| Usage: | |
| Shader Graph | ● As a separate property:<br/> <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/space-sg-1.webp" height="auto" width="400" border="2px" style="border-radius:1vh" /> <br/> ● As a suffix in an existing property:<br/> <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/space-sg-2.webp" height="auto" width="400" border="2px" style="border-radius:1vh" /> |
...
| Result | <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/space-result.png" height="auto" width="400"  border="2px" style="border-radius:1vh" />|
