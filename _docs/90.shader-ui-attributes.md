...
| Notes | ● This attribute can be applied only on `Texture2D` properties.<br/>● The HDR parameter is optional. If not specified, the default value is used (which is false). |
| Usage: | |
