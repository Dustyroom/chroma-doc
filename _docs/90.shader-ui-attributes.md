...
| Usage: | |
| ● Shader Graph | <img src="https://chroma.dustyroom.com/assets/images/docs/attributes/header-sg.webp" height="auto" width="300" style="border-radius:5%" /> |
| ● Code | `_AnyNameHere("[Header] My Header", Float) = 0.5` |
| Result | <kbd><img src="https://chroma.dustyroom.com/assets/images/docs/attributes/header-result.png" /></kbd> |
