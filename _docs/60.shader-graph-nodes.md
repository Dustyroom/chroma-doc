...
<img src="/assets/images/docs/examples/shader-graph-example-blackboard.png" height="auto" width="500" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh" />
...
<img src="/assets/images/docs/examples/shader-graph-example-settings.png" height="auto" width="500" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh" />
