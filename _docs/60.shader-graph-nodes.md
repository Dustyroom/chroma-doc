...
<img src="/assets/images/shader-graph/sample-gradient-texture.png" alt="Sample Gradient Texture" height="auto" width="300" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh" />
...
<img src="/assets/images/shader-graph/sample-hdr-gradient-texture.png" alt="Sample HDR Gradient Texture" height="auto" width="300" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh" />

* **Sample Curve Texture** - allows you to get a value from a curve.

<img src="/assets/images/shader-graph/sample-curve-texture.png" alt="Sample Curve Texture" height="auto" width="300" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh" />
