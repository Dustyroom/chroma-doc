...
<img src="/assets/images/docs/shader-graph/sample-gradient-node.png" alt="Sample Gradient Texture" height="auto" width="300" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh; display: block; margin-left: auto; margin-right: auto;">
...
![](/assets/images/docs/shader-graph/sample-hdr-gradient-node.png){: .image-fancy}

* **Sample Curve Texture** - allows you to get a value from a curve.

<img src="/assets/images/docs/shader-graph/sample-curve-node.png" alt="Sample Curve Texture" height="auto" width="300" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh; display: block; margin-left: auto; margin-right: auto;" />
...
<img src="/assets/images/docs/examples/code-shader-example.png" height="auto" width="800" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh; display: block; margin-left: auto; margin-right: auto;" />
...
<a href="/assets/images/docs/examples/shader-graph-example-graph.png"><img src="/assets/images/docs/examples/shader-graph-example-graph.png" alt="Shader Graph" height="auto" width="800" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh display: block; margin-left: auto; margin-right: auto;" /></a>
...
<img src="/assets/images/docs/examples/shader-graph-example-blackboard.png" height="auto" width="500" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh display: block; margin-left: auto; margin-right: auto;" />
...
<img src="/assets/images/docs/examples/shader-graph-example-settings.png" height="auto" width="500" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh display: block; margin-left: auto; margin-right: auto;" />
