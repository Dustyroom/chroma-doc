...
<img src="/assets/images/docs/examples/shader-graph-example-graph.png" height="auto" width="800" style="border-style:solid; border-color:darkgray; border-width:thick; border-radius:1vh" />
