...
For a detailed example of how to use gradients in Shader Graph, please refer to the [Shader Graph Documentation](/shader-graph-nodes/) section.
{: .notice--info}

For a detailed example of how to use gradients in code shaders, please refer to the [Code Shader Documentation](/code-shaders/) section.
{: .notice--info}
